...
app.get("/long-cork-up-slints", ((req,res)=>{
    res.render('long-cork-up-slints', {title: "long-cork-up-slints", count:  req.session.count})
}))
...
app.get("/posterior_limb", ((req,res)=>{
    res.render('posterior_limb', {title: "posterior_limb",count:  req.session.count})
}))
// product ten
app.get("/Quadriceps_benches", ((req,res)=>{
    res.render('Quadriceps_benches', {title: "Quadriceps_benches", count:  req.session.count})
}))

// product eleven
app.get("/Reciprocal_pulley", ((req,res)=>{
    res.render('Reciprocal_pulley', {title: "Reciprocal_pulley",count:  req.session.count})
}))
...
app.get("/Standing_frame", ((req,res)=>{
    res.render('Standing_frame', {title: "Standing_frame",count:  req.session.count})
}))

// product fourteen
app.get("/Trunk_support", ((req,res)=>{
    res.render('Trunk_support', {title: "Trunk_support",count:  req.session.count})
}))
